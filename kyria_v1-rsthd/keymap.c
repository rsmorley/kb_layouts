 ...
 */
    [_BASE] = LAYOUT(
      ...
      KC_GRV, KC_SLSH,     KC_V,        KC_G,        KC_P,        KC_B, TD(TD_SNST),  KC_NO,   KC_NO, TD(TD_CP_PT), KC_X,  KC_W,        KC_DOT,      KC_SCLN,     KC_MINS,     KC_QUOT,
                TG(_QWERTY), LT(_FUNC_MED, KC_LBRC), LT(_NUM_NAV, KC_E), KC_BSPC, SS_EMAIL, QK_REP, LT(_FUNC_MED, KC_ENT), LT(_NUM_NAV, KC_SPC),  KC_RBRC, KC_MPLY
    ),
/*
 ...
 */
  ...
  */
     [_NUMPAD] = LAYOUT(
       ...
       _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DOT , KC_1   , KC_2   , KC_3   , _______, _______,
